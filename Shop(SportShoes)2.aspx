<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage2.master" AutoEventWireup="true" CodeFile="Shop(SportShoes)2.aspx.cs" Inherits="Shop_SportShoes_2" %>
           ...
           <table style="width: 1880px">
            ...
            <tr>
                <td style="font-size: 25pt">
                    ...
                    <asp:Button ID="Button2" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button2_Click" PostBackUrl="~/ShoppingCart.aspx" />
                    <br />
                    <br />
                    </strong>
                ...
                <td style="font-size: 25pt">
                    ...
                    <asp:Button ID="Button1" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button1_Click" PostBackUrl="~/ShoppingCart.aspx" />
                    <br />
                    <br />
                    </strong>
                ...
                <td style="font-size: 25pt">
                    ...
                    <asp:Button ID="Button3" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button3_Click" PostBackUrl="~/ShoppingCart.aspx" />
                    </span><br />
                    <br />
                    </strong>
                ...
                <td style="font-size: 25pt">
                    ...
                    <span style="color: #333333">Men Running</span><br />
                    <span style="color: #FFFFFF">RM599</span><br />
                    <asp:Button ID="Button8" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button8_Click" PostBackUrl="~/ShoppingCart.aspx" />
                    <br />
                    <br />
                    </strong>
            ...
            <tr>
                <td style="font-size: 25pt">
                    ...
                    <asp:Button ID="Button4" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button4_Click" PostBackUrl="~/ShoppingCart.aspx"/>
                    <br />
                    <br />
                    </strong>
                  ...
                  <td style="font-size: 25pt">
                    ...
                    <asp:Button ID="Button5" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button5_Click" PostBackUrl="~/ShoppingCart.aspx"/>
                      <br />
                      <br />
                    </strong>
                  ...
                  <td style="font-size: 25pt">
                    ...
                    <span style="color: #333333">Men Originals</span><br />
                    <span style="color: #FFFFFF">RM640</span><br />
                    <asp:Button ID="Button6" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button6_Click" PostBackUrl="~/ShoppingCart.aspx"/>
                      <br />
                      <br />
                    </strong>
                ...
                <td style="font-size: 25pt">
                    ...
                    <asp:Button ID="Button7" runat="server" BackColor="Black" BorderColor="White" BorderStyle="Solid" Height="50px" style="color: #FFFFFF; font-size: 15pt; font-weight: 700" Text="Add To Cart" Width="155px" OnClick="Button7_Click" PostBackUrl="~/ShoppingCart.aspx"/>
                    <br />
                    <br />
                    </strong>
...
&nbsp;&nbsp;&nbsp;&nbsp;
             <asp:LinkButton ID="LinkButton3" runat="server" style="color: #660033; font-size: 35pt;" PostBackUrl="~/Shop(LeatherShop)2.aspx">Leather Shoes</asp:LinkButton>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         </div>
         </div>
