<%@ Page Title="" Language="C#" MasterPageFile="~/UserMasterPage2.master" AutoEventWireup="true" CodeFile="ContactUs2.aspx.cs" Inherits="ContactUs2" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Label ID="Label1" runat="server" Text="Your Name: " style="font-size: 30pt"></asp:Label>
                        ...
                        &nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtCustomerName" runat="server" Height="50px" Width="300px" style="font-size: 20pt"></asp:TextBox>
                        </td>
 ...
 <asp:Label ID="Label4" runat="server" Text="Your Email:" style="font-size: 30pt; font-weight: 700;"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtCustomerEmail" runat="server" Height="50px" Width="300px" style="font-size: 20pt"></asp:TextBox>
                            </td>
                    </tr>
                    <tr>
                        <td class="auto-style5">
...
<asp:Label ID="Label2" runat="server" Text="Subject:" style="font-size: 30pt"></asp:Label>
                        &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
                            <asp:TextBox ID="txtSubject" runat="server" Height="50px" Width="300px" style="font-size: 20pt"></asp:TextBox>
                        </td>
                        <td class="auto-style6">
...
<asp:Label ID="Label5" runat="server" Text="Message: " style="font-size: 30pt; font-weight: 700;"></asp:Label>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtMessage" runat="server" Height="117px" Width="300px" style="font-size: 20pt"></asp:TextBox>
                            </td>
                    </tr>
        ...
        <div class="auto-style1">
            ...
            <asp:Button ID="btnSend" runat="server" Height="50px" OnClick="btnSend_Click" style="font-size: 20pt; font-weight: 700; color: #800000" Text="Send" Width="150px" />
