<%@ Page Title="" Language="C#" MasterPageFile="~/StaffMasterPage.master" AutoEventWireup="true" CodeFile="Admin Edit Product.aspx.cs" Inherits="Admin_Edit_Product" %>
...
.sectThree
{
    ...
    background-repeat: no-repeat;
     ...
     <div class="container">
        ...
        <h3 style="font-size: 35pt; height: 104px;" class="auto-style9">You can <span class="auto-style13">Edit</span> any product in this webpage</h3></div>
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <td class="auto-style5">
                            ...
                            <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="Id" DataSourceID="SqlDataSource2" Height="50px" OnItemUpdated="DetailsView1_ItemUpdated" Width="125px">
                                <Fields>
